    ...
    return (
        <div className={styles.banner}>
            <h1 className={styles.banner_title}>Hackathon
                <span className={styles.banner_title_second}> Santri 2K21</span>
            </h1>
            ...
            <Link href="https://stackoverflow.com/" passHref={true}>
                <div className={styles.watch_video_section}>
            ...
            <div className={styles.mobile_contact_us_section}>
                <Link href="/">
                    <a className={styles.mobile_contact_us}>Contact Us</a>
                </Link>
            </div>
        </div>
    )
